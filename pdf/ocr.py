...
CACHE_ENV = "PDF_LEARNER_PADDLEOCR_CACHE"
...
DET_MODEL_ENV = "PDF_LEARNER_PADDLEOCR_DET_MODEL"
DET_LIMIT_SIDE_LEN_ENV = "PDF_LEARNER_PADDLEOCR_DET_LIMIT_SIDE_LEN"
CPU_THREADS_ENV = "PDF_LEARNER_PADDLEOCR_CPU_THREADS"

# pdf-learner가 사용자에게 제공하는 OCR 언어는 두 가지로 한정한다. 환경변수로
